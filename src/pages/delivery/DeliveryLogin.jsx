      ...
      <div className="w-full max-w-md">
        <Card padding="lg">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Delivery Partner Login</h1>
            <p className="text-xs text-slate-500 mt-1">Access your EATOGGY partner portal</p>
          </div>
