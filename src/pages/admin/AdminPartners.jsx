      ...
      render: (row) => (
        <div>
          <div className="font-medium text-gray-800 flex items-center gap-1.5">
            {row.ownerName}
            {row.isPhoneVerified && <span title="Phone Verified" className="text-emerald-600 text-[10px] font-semibold">✓ Verified</span>}
          </div>
          <div className="text-xs text-gray-500 flex items-center gap-1 mt-0.5">
            <Phone size={12} className="text-gray-400" /> {row.mobile}
          </div>
          {row.email && (
            <div className="text-xs text-gray-400 flex items-center gap-1 mt-0.5 truncate max-w-[180px]">
